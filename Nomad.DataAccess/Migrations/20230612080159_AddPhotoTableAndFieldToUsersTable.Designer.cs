...
namespace Nomad.DataAccess.Migrations
{
    ...
    [Migration("20230612080159_AddPhotoTableAndFieldToUsersTable")]
    partial class AddPhotoTableAndFieldToUsersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nomad.DataAccess.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nomad.DataAccess.Entities.Photo", b =>
                {
                    b.HasOne("Nomad.DataAccess.Entities.User", "User")
                        .WithOne("Photo")
                        .HasForeignKey("Nomad.DataAccess.Entities.Photo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Nomad.DataAccess.Entities.UserReviews", b =>
                {
                    ...
                    b.HasOne("Nomad.DataAccess.Entities.User", "UserReviewed")
                        .WithMany()
